...
此文档包含了背景介绍、功能特性、使用指南、API简介、消息处理机模板项目、架构设计以及性能压测。如果你想使用KClient快速的构建Kafka处理机服务，请参考消息处理机模板项目章节; 如果你想了解KClient的其他使用方式和特性，请参考背景介绍、功能恶性、使用指南、API间接等章节; 如果你想更深入的理解KClient的架构设计和性能Benchmark，请参考架构设计和性能压测章节。
